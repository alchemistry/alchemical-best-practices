...
\begin{figure}
    \includegraphics[width=0.95\linewidth]{paper/figures/fig1_what_is_alchemy/Fig1.pdf}    \caption{Illustration of different types of free energies differences that can be computed using alchemical free energy calculations. A: Change in free energy due to a conformational change. B: Partition coefficient such as $\log P$ or $\log D$, here as an example the partition coefficient between methanol and water of a given molecule. C: Free energies of membrane insertions. D: Simulations of portein or other host molecule simulations. E: Absolute free energies of binding of a small molecule to a host (e.g. protein), F: Relative free energy of binding of one molecule with respec to another, here toluene and benzyl alcohol.
...
\begin{figure}
    \includegraphics[width=0.95\columnwidth]{paper/figures/fig2_what_is_lam/Fig2.pdf}
...
\begin{figure}
    \includegraphics[width=0.95\columnwidth]{paper/figures/fig3_therm_cycle/Fig3.pdf}
...
When starting an alchemcial free energy project you need to determine if an alchemical free energy calculation is the appropriate strategy by initially counting the cost of your
...
\begin{figure}
    \includegraphics[width=0.95\linewidth]{paper/figures/fig4_topol/Fig4.pdf}
...
\begin{figure}
    \includegraphics[width=0.95\linewidth]{paper/figures/fig6_thermo_cyc_abs/fig6_therm_abs.pdf}
...
\subsubsection*{What different samples schemes exist and which one should I use?}

\begin{figure}
    \centering
    \includegraphics[width=0.95*\columnwidth]{paper/figures/fig7_sampl_scheme/sampling_schemes.pd}
    \caption{\textbf{There are 4 different sampling strategies available and implemntations are availble for different software packages.} A: Multiple replicas in parallel at different lambda states. B: Hamiltonian replica exchange scheme. C: Single replica scheme sampling from all $\lambda$ states. D: Non-equilibrium sampling scheme.}
...
\end{eqnarray}
For a Hamiltonian replica exchange simulation where the super-replica state $(X_t, S_t) \sim \Pi(X_t, S_t)$, where $X \equiv \{x_1, \ldots, x_K\}$ are the positions and $S \equiv \{s_1, \ldots, s_K}$ is the alchemical state permutation vector, the negative logarithm of the super-replica reduced potential is used:
\begin{eqnarray}
...
\begin{figure}
\includegraphics[width=0.95\columnwidth]{paper/figures/fig8/Fig8.pdf}
...
\textit{JS}: created figures 1, 3-6 and contributed to general formatting discussions. 
