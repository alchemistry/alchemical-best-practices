...
\textbf{LNN}: Helped write the simulation length, stopping conditions, and information saving section.\\
...
\textbf{JM}: Contributed to sections~\ref{subsec:reproducible},~\ref{sec:prerequisites},~\ref{} 4.2, 5.3, 6, 8.3.1, 8.3.2\\
