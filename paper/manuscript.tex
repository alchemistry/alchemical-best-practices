...
%MRS: Finlay, you can add information about RED here. 
...
Therefore, $\mathrm{var}$($\Delta$f) = $\sum_{i=1}^{K}w_{k}^2 \mathrm{var}(\frac{du}{d\vec{\lambda}})_{k}$, where the $w_k$ are the integration weights (see Sec~\eref{subsec:estimators} for more discussion of $w_k$).
