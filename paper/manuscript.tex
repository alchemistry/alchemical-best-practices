...
\sbnote{I think this should get its own paragraph/subsection; to be expanded!} Software packages vary in their use of single or dual topology approaches; for example, AMBER TI uses a DCDT approach, while BioSimSpace uses a SCST approach for all engines it supports. Please make sure to check what approach is used with your software package of choice, or whether it supports your choice of approach (GROMACS and GROMOS, for example, support both). 
...
\textbf{DMY:} Contributed to the discussion of topologies in Sec.~\ref{sec:relative-fe-protocol}, reviewed the updates to Sec.~\ref{sec:theory}, and made minor comments and additions throughout. \\
