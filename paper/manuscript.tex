...
%%%%%% step 4
\begin{tcolorbox}[width=15cm, center]
    {\large {\color{teal}STEP 4: HOW DO I KNOW WHICH SIMULATIONS ARE NOT RELIABLE?}} \newline
    \textbf{Situations suggesting your relative alchemical free energy calculations have not run properly (assuming absence of experimental affinities)}
    \item Standard error (\textsigma) should be \textless1 kcal·mol-1 
    \item Simulated systems have not converged 
    \newline\newline\textit{Relative:}
...
%%%%%% step 5
\begin{tcolorbox}[width=15cm, center]
    {\large {\color{teal}STEP 5: WHY ARE THEY NOT RELIABLE?}} \newline
...
%%%%%% step 6
\begin{tcolorbox}[width=15cm, center]
    {\large {\color{teal}STEP 6: DATA ANALYSIS}} \newline
...
JS: created figures \ref{fig:fig1_what_is_alchemy}, \ref{fig:fig3_binding-thermodynamic-cycle}-\ref{fig:fig6_absolute-thermodynamic-cycle} and contributed to general formatting discussions. 
