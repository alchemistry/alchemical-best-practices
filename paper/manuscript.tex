...
\item correlated bootstrap versus timeseries subsampling.
\begin{itemize}
\item Quantifying standard error in dG estimate
\item Variance in dG estimate using multiple methods (TI, DEXP, IEXP, BAR, MBAR, GDEL, etc.)
...
\item looking at the overlap matrix and making sure that there is decent overlap between all states.
