...
This guide can also serve as a set of best practices to ensure simulation robustness and reproducibility which reviewers may wish to consider.
...
\end{equation}
The objective of alchemical solvation free energy calculations is to implement Eq.~(\ref{eq:zratio-solv-dgexc}), by means of \emph{coupling} or \emph{decoupling} computational protocols and alchemical intermediate states as discussed in section \ref{subsec:numerical-implementations}.  Subsequent sections will also discuss computationally efficient approaches to calculate this ratio of integrals.
