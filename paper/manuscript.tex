...
\begin{checklist}{How do I know which simulations are unreliable?}
    ...
    \item Simulated systems have not converged - this
...
JDC is a current member of the Scientific Advisory Board of OpenEye Scientific Software and a consultant to Foresite Laboratories. A complete funding history for the Chodera lab can be found at http://choderalab.org/funding. DLM appreciates financial support from the National Institutes of Health (1R01GM108889-01, 1R01GM124270-01A1 and R01GM132386), and the National Science Foundation (CHE 1352608).
