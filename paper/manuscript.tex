...
When operating with a single set of coordinates for the region undergoing the alchemical transformation, an additional distinction between approaches concerns the atom mapping between end state molecules. %Often this is predetermined by the choice of simulation software.
