...
proposed target.
\todo[inline, color={blue!20}]{@Gary, here may be a good spot to add some lessons learned from FEP in drug discovery. Otherwise feel free to find your own suitable spot, or do edits in multiple places. }
%
%
%
%%%%%%%%%%%%
