...
In this paper, we review current best practices for several popular application domains of  alchemical free energy calculations performed with molecular dynamics simulations, with a particular focus on the intricacies and challenges of relative and absolute free energy calculations of binding of small molecules to biomolecular targets. We focus on ``single calculations'' where the quantity of interest is a single free energy difference; best practices for large-scale free energy calculations are discussed in an upcoming companion article~\cite{mey_largescale_inprep}.
