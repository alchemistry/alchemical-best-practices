...
Since sampling all of phase space is prohibitively expensive to satisfy the ergodic theorem, certain considerations are often made to to still assess uncertainties in computed free energy estimates. If a system exhibits a stable strong binding pose a short number of simulation repeats often offer adequate free energy estimates. However, situations with more flexible binding and poses will require more strategic sampling schemes to get estimate uncertainties.  
