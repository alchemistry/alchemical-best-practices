...
In the remainder of this paper, we will cover topics that are key to the preparation~(\ref{sec:step1}), choice and use of correct protocols~(\ref{sec:step2}), and finally the best practices that should be used for the analysis of alchemical calculations~(\ref{sec:data_analysis}). 
