...
\begin{eqnarray}
Z(\lambda) &=& \int_{\Gamma} d\vec{q} \, \exp({-u(\vec{q}; \lambda)}) ,
...
\todo[inline]{Do we really need this section? Everything has been referenced}
\begin{itemize}
...
\textbf{AR}: Created figure~\ref{fig:freeenergytrajectories}, contributed to section \ref{sec:simulation_protocol_choice}, and helped edit the paper.\\
\textbf{MRS}: Helped create figure~\ref{fig:fig_what_is_lambda}, wrote sections describing choices for alchemical pathways and analysis for free energy calculations.\\
...
MK and JM acknowledges funding through Innovate UK by KTP partnership 011120.
