...
Commonly in molecular simulations, bonds involving hydrogen are constrained to a fixed length using algorithms such as SHAKE or LINCS, rather than being allowed to vibrate.  This approach enables the use of longer timesteps~\cite{krautler2001fast}.
