...
In this paper, we review current best practices for several popular application domains of  alchemical free energy calculations, with a particular focus on the intricacies and challenges of relative and absolute free energy calculations of the binding of small molecules to biomolecular targets. We focus on ``single calculations'' where the quantity of interest is a single free energy difference; best practices for large-scale free energy calculations are discussed in an upcoming companion article~\cite{mey_largescale_inprep}.
...
In this document, we assume that novice practitioners have at least moderate experience with molecular simulation concepts and use of simulation packages. 
...
\begin{itemize}
    \item Is my problem suitable for an alchemical calculation? 
     \item How do I prepare my system to carry out an alchemical calculation?
...
We will give particular focus to aspects of the molecular simulations which are unique to alchemical calculations---these include the calculation of transfer free energies (hydration free energies, partition coefficients, etc.), and binding free energies (absolute and relative). 
