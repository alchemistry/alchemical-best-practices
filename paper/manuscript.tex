...
This choice also couples to the choice of restraints selected, as some types of restraints will allow transitions between binding modes and even binding sites (Sec.~\ref{sec:standardstate-restraints}), and others do not.
...
While this approach has precedent and has been used prospectively for molecular design, it is relatively difficult to automate at present and requires considerable care.
