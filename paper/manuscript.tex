...
\affil[13]{Molecular Sciences Software Institute, Blacksburg VA, USA}
...
\todo[inline, color={red!40}]{LNN: write common principles alchemical path choice. MRS: mostly wrote this, LNN can comment on it,}
...
JM: Contributed to sections~\ref{subsec:reproducible},~\ref{sec:step1},~\ref{} 4.2, 5.3, 6, 8.3.1, 8.3.2\todo[inline, color={red!20}]{@Julien insert info here}
JDC: \todo[inline, color={red!20}]{@JDC insert info here}
HX: \todo[inline, color={red!20}]{@Huafeng insert info here}
