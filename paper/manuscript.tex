...
It is worth highlighting a recent SAMPL blind challenge on HIV integrase as an illustration of the difficulty of performing reliable free energy calculations without clear knowledge of the binding site. 
...
Sampling all potential ligand binding modes within a single free energy calculation is usually impractical without some form of enhanced sampling or at least Hamiltonian replica exchange~\cite{wang2013identifying} because barriers for binding mode interconversion result in kinetics are generally too slow compared to simulation timescales~\cite{mobley2006use, palma2012computation,mobley2012perspective, gill2018binding}.
...
\begin{itemize}
 \item Check your ligands have the biologically correct binding pose(s)
        ...
        \item Apply the appropriate standard state ``correction'' terms
