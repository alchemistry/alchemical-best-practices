...
\begin{figure}
    \includegraphics[width=0.95\linewidth]{figures/fig1/Fig1.pdf}
...
\begin{figure}
    ...
    \caption{{\bf Illustration of $\lambda$}}
    \label{fig:what_is_lambda}
\end{figure}
\begin{equation}
...
\begin{figure}
    \includegraphics[width=0.95\columnwidth]{paper/figures/fig3/Fig3.pdf}
